...
Parameterization_FS_Uniform::Parameterization_FS_Uniform()
{
...
void Parameterization_FS_Uniform::Generate_CoefMatrix(vector<HE_vert* > vertices_)
{
...
void Parameterization_FS_Uniform::Do_Parameterizing(vector<HE_vert*> &vertices_)
{
	int num_ = vertices_.size();
