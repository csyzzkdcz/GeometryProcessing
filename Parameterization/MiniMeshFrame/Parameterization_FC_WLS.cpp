...
Parameterization_FC_WLS::Parameterization_FC_WLS()
{
...
void Parameterization_FC_WLS::Do_Parameterizing(vector<HE_vert*> &vertices_)
{
...
void Parameterization_FC_WLS::Generate_CoefMatrix(vector<HE_vert* > vertices_)
{
