...
Parameterization_FC_SP::Parameterization_FC_SP()
{
...
void Parameterization_FC_SP::Shape_Preserve_Mapping(HE_vert* vertex_, vector<float> &neighbor_rx_, vector<float> &neighbor_ry_)
{
	neighbor_rx_.clear();
	neighbor_ry_.clear();
...
float Parameterization_FC_SP::Tri_Area(float rx_1_, float ry_1_, float rz_1_, float rx_2_, float ry_2_, float rz_2_, float rx_3_, float ry_3_, float rz_3_)
{
	float d1_, d2_, d3_,p;
...
void Parameterization_FC_SP::Get_SP_Barycentry(HE_vert* vertex_, vector<float> &weight_)
{
...
void Parameterization_FC_SP::Generate_CoefMatrix(vector<HE_vert* > vertices_)
{
...
void Parameterization_FC_SP::Do_Parameterizing(vector<HE_vert*> &vertices_)
{
	int num_ = vertices_.size();
