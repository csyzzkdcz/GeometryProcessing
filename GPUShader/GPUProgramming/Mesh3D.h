...
public:
	...
	*/
	...
	/////////////////////////////////////////////
	//"LoadFromOBJFile" function compute normal itself rather than reading normal from obj.
	//This fuction read normal from obj.
	//Add by Chi Zhang on 2017.4.4
	/////////////////////////////////////////////
	bool LoadFromOBJFileWithNormal(const char* fins);
	//! export the current mesh to an OBJ format file
	void WriteToOBJFile(const char* fouts);

	/////////////////////////////////////////////
	//"WriteFromOBJFile" function doesn't write normal information.
	//This fuction writes normal information to obj.
	//Add by Chi Zhang on 2017.4.4
	/////////////////////////////////////////////
	void WriteToOBJFileWithNormal(const char* fouts);
...
public:
	...
	void SphereTex()
	{
		...
		for (size_t i=0; i != num_of_vertex_list(); ++i)
		{
			...
			point p = vert->normal()*vert->position().length();
